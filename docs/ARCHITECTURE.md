...
The cost is that the Windows agent is two files rather than one. The installer hides it; the archive explains it; and an executable separated from its loader degrades to the path below rather than breaking.
